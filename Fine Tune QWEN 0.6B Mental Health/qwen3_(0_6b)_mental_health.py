# -*- coding: utf-8 -*-
"""Qwen3_(0.6B)-Mental Health.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1uhMN2ayUZk8JD1FIqETEax5KT2pH6zPt
...
non_reasoning_dataset = load_dataset("Amod/mental_health_counseling_conversations", split = "train")
...
non_reasoning_conversations = tokenizer.apply_chat_template(
    non_reasoning_dataset.map(generate_conversation, batched = True)["conversations"],
    tokenize = False,
)
...
files.download('/content/lora_model.zip')
